...
neg<-c(0.995,0.9,0.7)
gri<-c(0.92,0.85,0.65)
bla<-c(0.002,0.005,0.01)
datos=data.frame()
...
pruebas=rep(c("n1g1b1","n1g1b2","n1g1b3","n1g2b1","n1g2b2","n1g2b3","n1g3b1","n1g3b2","n1g3b3",
            ...
            times=c(10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10))
...
ggplot(dat.m, aes(x= combo, y= value, fill= combo)) + # fill=name allow to automatically dedicate a color for each group
  geom_boxplot()+ labs(x="combo", y= "valor f") +
